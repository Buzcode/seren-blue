...
export const login = async (req, res) => {
    ...
    try {
        ...
        // **MODIFIED LINE: Encode JWT_SECRET_KEY as UTF-8 Buffer**
        const secretKeyBuffer = Buffer.from(JWT_SECRET_KEY, 'utf-8');

        const token = jwt.sign(
            payload,
            secretKeyBuffer, // **MODIFIED LINE: Use secretKeyBuffer for signing**
            { algorithm: "HS256", expiresIn: lifetime }
        );
        console.log("authController.js - JWT_SECRET_KEY (signing):", JWT_SECRET_KEY);
