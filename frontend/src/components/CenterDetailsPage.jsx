                    ...
                    <div className="flex flex-col lg:flex-row gap-6">
                        ...
                        <div className="flex flex-col p-2 w-full lg:w-1/4">
                            ...
                            <div className='mb-4'>
                                ...
                                <div className='flex items-center mb-2'>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6 text-blue-600">
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.077 1.98l-8.478 5.233a1.5 1.5 0 01-1.422 0l-8.478-5.233A2.25 2.25 0 012.25 6.993V6.75m19.5 0a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25" />
                                    </svg>
                                    <div className='flex flex-col ml-2'>
                            ...
                            >
                                <span className='flex items-center justify-center'>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-4 h-4 mr-2">
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M6 12L3.269 3.126A59.769 59.769 0 0121.485 12a59.77 59.77 0 01-2.736 8.876L18 12m-6 6h.01m6-6h.01m-3 6V6a3 3 0 00-3-3H9a3 3 0 00-3 3v12m6 0h.01m-3-6h.01" />
                                    </svg>
                                    Message
                                </span>
                            </button>
                    ...
                    <div className='flex justify-between items-center'>
                        ...
                        <span className='flex items-center text-blue-700 font-semibold'>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-4 h-4 mr-1">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v12m-3-2.818l.879.659c1.171.879 3.079.879 4.25 0l.879-.66M12 21a9 9 0 110-18 9 9 0 010 18z" />
                            </svg>
